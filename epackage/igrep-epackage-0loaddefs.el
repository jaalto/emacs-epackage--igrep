...
;;;### (autoloads nil "igrep" "igrep.el" (0 0 0 0))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "igrep" '("igrep-")))

;;;***
(provide 'igrep-mode-epackage-0loaddefs)
